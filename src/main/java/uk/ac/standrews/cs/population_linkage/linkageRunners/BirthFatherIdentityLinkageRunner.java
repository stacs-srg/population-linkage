...
public class BirthFatherIdentityLinkageRunner extends LinkageRunner {
    ...
    public static final String linkageType = "birth-father-id";
    ...
    public LinkageRecipe getLinkageRecipe(final String links_persistent_name,
        ...
        return new BirthFatherIdentityLinkageRecipe(results_repository_name, links_persistent_name, source_repository_name, record_repository);
    }
