...
public class BrideBrideIdentityBuilder implements MakePersistent {
    ...
    public static void main(String[] args) throws BucketException {
        ...
        try (NeoDbCypherBridge bridge = new NeoDbCypherBridge() ) {
            BrideBrideIdentityLinkageRecipe linkageRecipe = new BrideBrideIdentityLinkageRecipe(sourceRepo, BrideBrideIdentityBuilder.class.getName(), bridge);
            ...
            while( linkage_fields >= half_fields ) {
                ...
                new BitBlasterLinkageRunner().run(linkageRecipe, new BrideBrideIdentityBuilder(), false, true);
