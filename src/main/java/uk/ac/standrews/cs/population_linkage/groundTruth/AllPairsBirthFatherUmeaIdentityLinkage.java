...
public class AllPairsBirthFatherUmeaIdentityLinkage extends AllPairsSameSourceLinkageAnalysis {
    ...
    public AllPairsBirthFatherUmeaIdentityLinkage(Path store_path, String repo_name, String linkage_results_filename, final String distance_results_filename) throws IOException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new AllPairsBirthFatherUmeaIdentityLinkage(store_path, repo_name, "UmeaBirthFatherIdentityLinkage", "UmeaThresholdBirthFatherIdentityDistances").run();
    }
