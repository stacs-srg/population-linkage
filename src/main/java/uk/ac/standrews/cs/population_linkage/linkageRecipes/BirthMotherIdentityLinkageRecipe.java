...
public class BirthMotherIdentityLinkageRecipe extends LinkageRecipe {
    ...
    public static boolean isViable(final LXP record1, final LXP record2) {
        ...
        return CommonLinkViabilityLogic.birthParentIdentityLinkIsViable(record1, record2, true);
    }
    ...
    private static final String BIRTH_MOTHER_GT_IDENTITY_LINKS_QUERY = "MATCH (a:Birth)-[r:GT_ID, { actors: \"Child-Mother\" } ]-(b:Birth) WHERE b.STANDARDISED_ID = $standard_id_from RETURN r";
