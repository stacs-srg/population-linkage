...
import uk.ac.standrews.cs.population_linkage.linkageRecipies.BirthMotherIdentityLinkageRecipe;
...
public class BirthMotherIdentityLinkageRunner extends LinkageRunner {

    public static final String linkageType = "birth-mother-id";
    ...
    public LinkageRecipe getLinkageRecipe(final String links_persistent_name, final String gt_persistent_name,
        ...
        return new BirthMotherIdentityLinkageRecipe(results_repository_name, links_persistent_name, gt_persistent_name, source_repository_name, record_repository);
    }
    ...
    public Linker getLinker(final double match_threshold, final Metric<LXP> composite_metric, final SearchStructureFactory<LXP> search_factory) {
        return new SimilaritySearchLinker(search_factory, composite_metric, match_threshold, getNumberOfProgressUpdates(),
                linkageType, "threshold match at " + match_threshold, Birth.ROLE_BABY, Birth.ROLE_FATHER, LinkagePostFilter::noViabilityCheck);
    }
    ...
    public static void main(String[] args) {
        ...
        new BirthMotherIdentityLinkageRunner()
                .run("BirthMotherIdentityLinks", "BirthMotherIdentityGroundTruth",
