...
import static uk.ac.standrews.cs.population_linkage.supportClasses.Constants.SED;
 ...
 */
public class FelligiSunterBirthGroomIdentityAnalysis extends TwoSourcesLinkageAnalysis {
    ...
    FelligiSunterBirthGroomIdentityAnalysis(final String repo_name, final String[] args) throws IOException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new FelligiSunterBirthGroomIdentityAnalysis(Umea.REPOSITORY_NAME, args).run();
    }
}
