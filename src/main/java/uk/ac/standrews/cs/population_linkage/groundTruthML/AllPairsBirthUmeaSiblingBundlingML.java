...
public class AllPairsBirthUmeaSiblingBundlingML extends AllPairsSameSourceLinkageAnalysisML {

    public AllPairsBirthUmeaSiblingBundlingML(Path store_path, String repo_name, final String distance_results_filename) throws IOException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new AllPairsBirthUmeaSiblingBundlingML(store_path, repo_name, "UmeaMLBirthSiblingDistances").run();
    }
