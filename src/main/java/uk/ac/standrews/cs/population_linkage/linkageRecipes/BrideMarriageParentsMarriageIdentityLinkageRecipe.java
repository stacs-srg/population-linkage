...
public class BrideMarriageParentsMarriageIdentityLinkageRecipe extends LinkageRecipe {
    ...
    private static final double DISTANCE_THRESHOLD = 0.89;
    ...
    public BrideMarriageParentsMarriageIdentityLinkageRecipe(String source_repository_name, String number_of_records, String links_persistent_name) {
