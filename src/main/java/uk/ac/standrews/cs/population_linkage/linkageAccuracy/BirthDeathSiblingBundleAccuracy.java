...
public class BirthDeathSiblingBundleAccuracy extends AbstractAccuracy {
    ...
    public BirthDeathSiblingBundleAccuracy(NeoDbCypherBridge bridge) {
        super(bridge);
    }
    ...
    public static void main(String[] args) {
        try (NeoDbCypherBridge bridge = new NeoDbCypherBridge()) {
            BirthDeathSiblingBundleAccuracy acc = new BirthDeathSiblingBundleAccuracy(bridge);
            acc.doqueries();
        }
    }
}
