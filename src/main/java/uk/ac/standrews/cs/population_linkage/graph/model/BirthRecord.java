...
public class BirthRecord extends VitalEventRecord {
    ...
    private List<Reference> sibling_records = new ArrayList<>();

    @Relationship(type="DEATH")
    private List<Reference> death_records = new ArrayList<>();

    @Relationship(type="FATHER")
    private List<Reference> father_records = new ArrayList<>();

    @Relationship(type="MOTHER")
    private List<Reference> mother_records = new ArrayList<>();

    @Relationship(type="SPOUSE")
    private List<Reference> spouse_records = new ArrayList<>();

    @Relationship(type="COPARENT")
    private List<Reference> coparent_records = new ArrayList<>();
    ...
    // GET OPERATIONS ON RELATIONSHIPS BETWEEN RECORDS

    public List<Reference> getSiblingRecords() {
        return sibling_records;
    }

    public List<Reference> getDeathRecords() {
        return death_records;
    }

    public List<Reference> getFatherRecords() {
        return father_records;
    }

    public List<Reference> getMotherRecords() {
        return mother_records;
    }

    public List<Reference> getSpouseRecords() {
        return spouse_records;
    }

    public List<Reference> getCoparentRecords() {
        return coparent_records;
    }

    // SET OPERATIONS ON RELATIONSHIPS BETWEEN RECORDS

    public void addSibling( Reference sibling ) {
        sibling_records.add( sibling );
    }

    public void addMother( Reference mother ) {
        mother_records.add( mother );
    }

    public void addFather( Reference father ) {
        father_records.add( father );
    }

    public void addSpouse( Reference spouse ) {
        spouse_records.add( spouse );
    }

    public void addCoparent( Reference coparent ) {
        coparent_records.add( coparent );
    }
