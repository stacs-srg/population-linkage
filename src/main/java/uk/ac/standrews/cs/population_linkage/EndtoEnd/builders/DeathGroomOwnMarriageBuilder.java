...
import uk.ac.standrews.cs.population_linkage.EndtoEnd.SubsetRecipies.DeathGroomIdentitySubsetLinkageRecipe;
...
public class DeathGroomOwnMarriageBuilder {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (NeoDbCypherBridge bridge = new NeoDbCypherBridge(); ) {
            LinkageRecipe linkageRecipe = new DeathGroomIdentitySubsetLinkageRecipe(sourceRepo, resultsRepo, bridge,DeathGroomOwnMarriageBuilder.class.getCanonicalName() );
