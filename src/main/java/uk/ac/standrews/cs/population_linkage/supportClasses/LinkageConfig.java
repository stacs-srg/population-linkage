...
public class LinkageConfig {
    ...
    public static Integer MAX_ALLOWABLE_AGE_DISCREPANCY = 10;          // Maximum tolerated discrepancy in years between ages calculated from different records in potential identity link.
