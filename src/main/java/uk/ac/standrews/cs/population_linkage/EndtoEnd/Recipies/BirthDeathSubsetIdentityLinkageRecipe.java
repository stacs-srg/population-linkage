...
public class BirthDeathSubsetIdentityLinkageRecipe extends BirthDeathIdentityLinkageRecipe {
    ...
    public BirthDeathSubsetIdentityLinkageRecipe(String source_repository_name, String results_repository_name, NeoDbCypherBridge bridge, String links_persistent_name, int prefilterRequiredFields ) {
    ...
    protected Iterable<LXP> getDeathRecords() {
        return filter(prefilterRequiredFields, EVERYTHING, super.getDeathRecords(), getQueryMappingFields());
    }
