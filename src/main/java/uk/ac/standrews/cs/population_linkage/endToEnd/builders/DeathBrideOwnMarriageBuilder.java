...
public class DeathBrideOwnMarriageBuilder {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (NeoDbCypherBridge bridge = new NeoDbCypherBridge()) {
            DeathBrideIdentitySubsetLinkageRecipe linkageRecipe = new DeathBrideIdentitySubsetLinkageRecipe(sourceRepo, number_of_records, bridge, DeathBrideOwnMarriageBuilder.class.getCanonicalName());
