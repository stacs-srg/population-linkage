...
// Copied from UmeaBirthMotherIdentity in umea.paper
 ...
 */
public class FelligiSunterBirthParentsMarriageAnalysis extends TwoSourcesLinkageAnalysis {
    ...
    FelligiSunterBirthParentsMarriageAnalysis(final String repo_name, final String[] args) throws IOException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new FelligiSunterBirthParentsMarriageAnalysis(Umea.REPOSITORY_NAME, args).run();
    }
}
