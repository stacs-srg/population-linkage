...
public class DeathBrideSiblingBundleBuilder implements MakePersistent {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try(NeoDbCypherBridge bridge = new NeoDbCypherBridge() ) {
            ...
            DeathBrideSiblingLinkageRecipe linkageRecipe = new DeathBrideSiblingLinkageRecipe(sourceRepo, number_of_records, DeathBrideSiblingBundleBuilder.class.getCanonicalName(), bridge);
            ...
            while( linkage_fields >= half_fields ) {
                ...
                LinkageResult lr = runner.run(linkageRecipe, new DeathBrideSiblingBundleBuilder(), false, false, false, true);
    ...
    public void makePersistent(LinkageRecipe recipe, Link link) {
        try {
            ...
            if( !std_id1.equals(std_id2 ) ) {
                ...
                if (!Query.DMBrideSiblingReferenceExists(recipe.getBridge(), std_id1, std_id2, recipe.getLinks_persistent_name())) {
