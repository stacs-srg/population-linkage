 ...
 */
public class GroomOwnMarriageToOwnBirthExperimentAl {
    ...
    public static void main(String[] args) throws BucketException {
        ...
        new BitBlasterSubsetOfDataEndtoEndBirthParentsMarriageLinkageRunner().run(linkageRecipe, new JensenShannon(2048), 0.67, true, 6, false, false, false, false);
