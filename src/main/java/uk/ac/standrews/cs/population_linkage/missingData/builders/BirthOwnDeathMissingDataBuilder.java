...
public class BirthOwnDeathMissingDataBuilder implements MakePersistent {
    ...
    private static void runExperiment(String source_repo, String number_of_records, String mode, int linkage_fields, NeoDbCypherBridge bridge) throws Exception {
        ...
        switch (mode) {
            ...
            case "missing-zero": {
                BirthDeathIdentityLinkageRecipe linkage_recipe = new BDLinkageRecipeMissingZero(source_repo, number_of_records, BirthOwnDeathMissingDataBuilder.class.getName());
            ...
            case "missing-one": {
                BirthDeathIdentityLinkageRecipe linkage_recipe = new BDLinkageRecipeMissingOne(source_repo, number_of_records, BirthOwnDeathMissingDataBuilder.class.getName());
                linkage_recipe.setNumberLinkageFieldsRequired(linkage_fields);
                new BitBlasterLinkageRunner().run(linkage_recipe,new BirthOwnDeathMissingDataBuilder(), true, false);
                break;
            }
            case "max": {
                BirthDeathIdentityLinkageRecipe linkage_recipe = new BDLinkageRecipeMax(source_repo, number_of_records, BirthOwnDeathMissingDataBuilder.class.getName());
                linkage_recipe.setNumberLinkageFieldsRequired(linkage_fields);
                new BitBlasterLinkageRunner().run(linkage_recipe,new BirthOwnDeathMissingDataBuilder(), true, false);
                break;
            }
            case "missing-half": {
                BirthDeathIdentityLinkageRecipe linkage_recipe = new BDLinkageRecipeMissingHalf(source_repo, number_of_records, BirthOwnDeathMissingDataBuilder.class.getName());
                linkage_recipe.setNumberLinkageFieldsRequired(linkage_fields);
                new BitBlasterLinkageRunner().run(linkage_recipe,new BirthOwnDeathMissingDataBuilder(), true, false);
                break;
            }
            case "mean-of-present": {
                BirthDeathIdentityLinkageRecipe linkage_recipe = new BDLinkageRecipeMeanOfPresent(source_repo, number_of_records, BirthOwnDeathMissingDataBuilder.class.getName());
                linkage_recipe.setNumberLinkageFieldsRequired(linkage_fields);
                new BitBlasterLinkageRunner().run(linkage_recipe,new BirthOwnDeathMissingDataBuilder(), true, false);
                break;
            }
