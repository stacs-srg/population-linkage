...
public class AllPairsBirthGroomMarriageUmeaIdentityLinkage extends AllPairs2SourcesLinkageAnalysis {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new AllPairsBirthGroomMarriageUmeaIdentityLinkage(store_path, repo_name,"UmeaThresholdBirthBridesGroomMarriageIdentityLinkage", "UmeaThresholdBirthGroomMarriageIdentityDistances").run();
    }
}
