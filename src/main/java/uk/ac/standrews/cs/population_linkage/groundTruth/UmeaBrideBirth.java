...
public class UmeaBrideBirth extends TwoSourcesLinkageAnalysis {
    ...
    public UmeaBrideBirth(Path store_path, String repo_name, String linkage_results_filename, final String distance_results_filename, int number_of_records_to_be_checked, int number_of_runs) throws IOException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new UmeaBrideBirth(store_path, repo_name,"UmeaBrideBirthPRFByThreshold", "UmeaBrideBirthLinksByDistance",DEFAULT_NUMBER_OF_RECORDS_TO_BE_CHECKED,NUMBER_OF_RUNS).run();
    }
}
