...
public class BirthGroomIdentitySubsetLinkageRecipe extends BirthGroomIdentityLinkageRecipe {
    ...
    public BirthGroomIdentitySubsetLinkageRecipe(String source_repository_name, String results_repository_name, NeoDbCypherBridge bridge, String links_persistent_name, int prefilterRequiredFields ) {
