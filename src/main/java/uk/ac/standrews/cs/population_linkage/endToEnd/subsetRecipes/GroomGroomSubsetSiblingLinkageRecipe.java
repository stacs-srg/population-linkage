...
public class GroomGroomSubsetSiblingLinkageRecipe extends GroomGroomSiblingLinkageRecipe {
    ...
    public GroomGroomSubsetSiblingLinkageRecipe(String source_repository_name, String number_of_records, NeoDbCypherBridge bridge, String links_persistent_name) {
    ...
    protected Iterable<LXP> getMarriageRecords() {
        if( cached_records == null ) {
            cached_records = RecordFiltering.filter(linkage_fields, NUMBER_OF_MARRIAGES, super.getMarriageRecords(), getLinkageFields());
        }
