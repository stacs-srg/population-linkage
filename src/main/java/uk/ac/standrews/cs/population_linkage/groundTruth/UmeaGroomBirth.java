...
public class UmeaGroomBirth extends TwoSourcesLinkageAnalysis {
    ...
    UmeaGroomBirth(Path store_path, String repo_name, int number_of_records_to_be_checked, int number_of_runs) throws IOException {
    ...
    protected LinkStatus isTrueMatch(LXP record1, LXP record2) {
        ...
        return child_id.equals(groom_id) ? LinkStatus.TRUE_MATCH : LinkStatus.NOT_TRUE_MATCH;
    }
