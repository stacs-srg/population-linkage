...
public class TestJS2 {
    ...
    public static void main(String[] args) throws BucketException {
        ...
        try (NeoDbCypherBridge bridge = new NeoDbCypherBridge()) {
            BirthDeathSubsetIdentityLinkageRecipe linkageRecipe = new BirthDeathSubsetIdentityLinkageRecipe(sourceRepo, number_of_records, bridge, TestJS2.class.getCanonicalName());
