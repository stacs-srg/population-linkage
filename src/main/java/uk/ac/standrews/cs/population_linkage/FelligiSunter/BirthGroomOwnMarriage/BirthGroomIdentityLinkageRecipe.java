...
public class BirthGroomIdentityLinkageRecipe extends LinkageRecipe {
    ...
    public static final String LINKAGE_TYPE = "birth-groom-identity-feligi-sunter";
    ...
    public BirthGroomIdentityLinkageRecipe(String source_repository_name, String number_of_records,  List<Double> m_priors, List<Double> u_priors, double odds_prior, String links_persistent_name) {
