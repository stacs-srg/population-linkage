 ...
 **/
public class UmeaBirthDeathViability extends TwoSourcesLinkageAnalysis {

    public UmeaBirthDeathViability(Path store_path, String repo_name, int number_of_records_to_be_checked, int number_of_runs) throws IOException {
    ...
    protected LinkStatus isTrueMatch(LXP record1, LXP record2) {
        ...
        return child_id.equals(deceased_id) ? LinkStatus.TRUE_MATCH : LinkStatus.NOT_TRUE_MATCH;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        new UmeaBirthDeathViability(store_path, repo_name, DEFAULT_NUMBER_OF_RECORDS_TO_BE_CHECKED, NUMBER_OF_RUNS).run();
    }
}
