...
public class GroomGroomSiblingLinkageRecipe extends LinkageRecipe {
    ...
    public GroomGroomSiblingLinkageRecipe(String results_repository_name, String links_persistent_name, String ground_truth_persistent_name, String source_repository_name, RecordRepository record_repository) {
            ...
            for (int j = i + 1; j < number_of_records; j++) {
                ...
                try {
                    if (isTrueMatch(record1, record2).equals(TRUE_MATCH)) {
                        ...
                        Link l = new Link(record1, Marriage.ROLE_GROOM, record2, Marriage.ROLE_GROOM, 1.0f, "ground truth");
