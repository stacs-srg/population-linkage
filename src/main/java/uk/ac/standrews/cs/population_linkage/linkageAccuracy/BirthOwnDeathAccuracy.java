...
public class BirthOwnDeathAccuracy extends AbstractAccuracy {
    ...
    private static final String BIRTH_DEATH_ID_TPC = "MATCH (b:Birth)-[r:DEATH]-(d:Death) WHERE (b)-[:GROUND_TRUTH_BIRTH_DEATH_IDENTITY]-(d) return count(r)";
    private static final String BIRTH_DEATH_ID_FPC = "MATCH (b:Birth)-[r:DEATH]-(d:Death) WHERE NOT (b)-[:GROUND_TRUTH_BIRTH_DEATH_IDENTITY]-(d) return count(r)";
    private static final String BIRTH_DEATH_ID_FNC = "MATCH (b:Birth)-[r:GROUND_TRUTH_BIRTH_DEATH_IDENTITY]-(d:Death) WHERE NOT (b)-[:DEATH]-(d) return count(r)";
