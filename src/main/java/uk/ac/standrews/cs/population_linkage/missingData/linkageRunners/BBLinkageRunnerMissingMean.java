...
public class BBLinkageRunnerMissingMean extends BitBlasterLinkageRunner {

    @Override
    protected Metric<LXP> getCompositeMetric(final LinkageRecipe linkageRecipe) {
        return new SigmaMissingMean(getBaseMetric(), linkageRecipe.getLinkageFields(), Birth.STANDARDISED_ID);
    }
