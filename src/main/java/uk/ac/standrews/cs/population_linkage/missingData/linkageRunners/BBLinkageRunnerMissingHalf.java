...
public class BBLinkageRunnerMissingHalf extends BitBlasterLinkageRunner {

    @Override
    protected Metric<LXP> getCompositeMetric(final LinkageRecipe linkageRecipe) {
        return new SigmaMissingHalf(getBaseMetric(), linkageRecipe.getLinkageFields(), Birth.STANDARDISED_ID);
    }
