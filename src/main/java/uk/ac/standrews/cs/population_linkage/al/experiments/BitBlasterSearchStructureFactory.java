...
public class BitBlasterSearchStructureFactory<LXP> implements SearchStructureFactory<LXP> {

    private final NamedMetric<LXP> composite_metric;

    public BitBlasterSearchStructureFactory(NamedMetric<LXP> composite_metric ) {
