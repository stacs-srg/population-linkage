...
public class PrintSkyeRecordsFromStoreSample {
    ...
    public PrintSkyeRecordsFromStoreSample(Path store_path, String repo_name) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new PrintSkyeRecordsFromStoreSample(store_path, repo_name).run();
    }
}
