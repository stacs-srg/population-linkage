...
public class UmeaGroomGroomSibling extends SymmetricSingleSourceLinkageAnalysis {
    ...
    UmeaGroomGroomSibling(final String repo_name, final String[] args) throws IOException {
    ...
    public boolean isViableLink(final LXP record1, final LXP record2) {
        return GroomGroomSiblingLinkageRecipe.isViable(record1, record2);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        new UmeaGroomGroomSibling(Umea.REPOSITORY_NAME, args).run();
    }
}
