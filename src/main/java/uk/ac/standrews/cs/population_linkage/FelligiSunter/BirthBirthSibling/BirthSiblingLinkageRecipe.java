...
public class BirthSiblingLinkageRecipe extends LinkageRecipe {
    ...
    public static final String LINKAGE_TYPE = "birth-birth-sibling-feligi-sunter";
    ...
    public BirthSiblingLinkageRecipe(String source_repository_name, String number_of_records, List<Double> m_priors, List<Double> u_priors, double odds_prior, String links_persistent_name) {
    ...
    public LXPMeasure getCompositeMeasure() {
        return new FelligiSunterDistances(getBaseMeasure(), getLinkageFields(), LINKAGE_FIELDS, m_priors, u_priors, odds_prior);
    }

    public LXPMeasure getCompositeMeasure(StringMeasure base_measure) {
        return new FelligiSunterDistances(base_measure, getLinkageFields(), LINKAGE_FIELDS, m_priors, u_priors, odds_prior );
    }}
