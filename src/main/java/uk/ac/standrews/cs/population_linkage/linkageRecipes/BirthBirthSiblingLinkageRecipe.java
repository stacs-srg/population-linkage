...
public class BirthBirthSiblingLinkageRecipe extends LinkageRecipe {
    ...
    public static void main(String[] args) throws BucketException {
        ...
        LinkageRecipe linkageRecipe = new BirthBirthSiblingLinkageRecipe(sourceRepo, resultsRepo, linkageType + "-links");
    ...
    public static LinkStatus trueMatch(LXP record1, LXP record2) {
        ...
        if (equalsNonEmpty(b1_mother_id, b2_mother_id) && equalsNonEmpty(b1_father_id, b2_father_id))
            return LinkStatus.TRUE_MATCH;

        if (equalsNonEmpty(b1_parent_marriage_id, b2_parent_marriage_id)) return LinkStatus.TRUE_MATCH;

        if (equalsNonEmpty(b1_mother_birth_id, b2_mother_birth_id) && equalsNonEmpty(b1_father_birth_id, b2_father_birth_id))
            return LinkStatus.TRUE_MATCH;
