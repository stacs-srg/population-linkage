...
public class BrideGroomSiblingBuilder implements MakePersistent {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try( NeoDbCypherBridge bridge = new NeoDbCypherBridge() ) {
            ...
            BrideGroomSiblingLinkageRecipe linkageRecipe = new BrideGroomSiblingLinkageRecipe(sourceRepo, number_of_records, BrideGroomSiblingBuilder.class.getCanonicalName(), bridge);
            ...
            while( linkage_fields >= half_fields ) {
                LinkageResult lr = runner.run(linkageRecipe, new BrideGroomSiblingBuilder(), false, false, false, true);
    ...
    public void makePersistent(LinkageRecipe recipe,Link link) {
        try {
            ...
            if( ! Query.MMBrideGroomSiblingReferenceExists(recipe.getBridge(), std_id1, std_id2, recipe.getLinks_persistent_name())) {
