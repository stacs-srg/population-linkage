...
import uk.ac.standrews.cs.population_linkage.linkageRecipies.BrideGroomSiblingLinkageRecipe;
...
public class BrideGroomSiblingLinkageRunner extends LinkageRunner {
    ...
    public LinkageRecipe getLinkageRecipe(final String links_persistent_name,
        ...
        return new BrideGroomSiblingLinkageRecipe(results_repository_name, links_persistent_name, source_repository_name, record_repository);
    }
    ...
    public Linker getLinker(final double match_threshold, LinkageRecipe linkageRecipe) {
        ...
        return new SimilaritySearchLinker(getSearchFactory(compositeMetric), compositeMetric, match_threshold, getNumberOfProgressUpdates(),
                linkageType, "threshold match at " + match_threshold, Marriage.ROLE_BRIDE, Marriage.ROLE_GROOM, LinkagePostFilter::noViabilityCheck, linkageRecipe);
    }
    ...
    public static void main(String[] args) {
        ...
        new BrideGroomSiblingLinkageRunner()
                .run("BrideGroomSiblingLinks",
