...
/**
 * This class performs sibling bundling linkage analysis on data from marriages  looking for two grooms who are brothers or a groom's remarriage.
 */
public class UmeaGroomGroomSibling extends SymmetricSingleSourceLinkageAnalysis {

    public UmeaGroomGroomSibling(Path store_path, String repo_name, String linkage_results_filename, final String distance_results_filename, int number_of_records_to_be_checked, int number_of_runs) throws IOException {
    ...
    protected LinkStatus isTrueLink(LXP record1, LXP record2) {
        ...
        // two grooms who are brothers or a remarriage.
        ...
        return  m1_groom_father_id.equals(m2_groom_father_id) && m1_groom_mother_id.equals(m2_groom_mother_id)  ? LinkStatus.TRUE_LINK : LinkStatus.NOT_TRUE_LINK;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        new UmeaGroomGroomSibling(store_path, repo_name, getLinkageResultsFilename(), getDistanceResultsFilename(), DEFAULT_NUMBER_OF_RECORDS_TO_BE_CHECKED, NUMBER_OF_RUNS).run();
    }
}
