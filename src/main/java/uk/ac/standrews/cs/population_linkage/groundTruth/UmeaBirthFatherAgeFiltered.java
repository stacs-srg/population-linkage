...
import uk.ac.standrews.cs.population_linkage.metrics.Sigma2AgeFiltered;
...
public class UmeaBirthFatherAgeFiltered extends AsymmetricSingleSourceLinkageAnalysis {

    public UmeaBirthFatherAgeFiltered(Path store_path, String repo_name, String linkage_results_filename, final String distance_results_filename, int number_of_records_to_be_checked, int number_of_runs) throws IOException {
    ...
    protected List<NamedMetric<LXP>> getCombinedMetrics() {
        ...
        for (final NamedMetric<String> base_metric : Utilities.BASE_METRICS) {
            result.add(new Sigma2AgeFiltered(base_metric, getComparisonFields(), getComparisonFields2(), Birth.BIRTH_YEAR, Birth.BIRTH_YEAR ));
        }
        return result;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        new UmeaBirthFatherAgeFiltered(store_path, repo_name, getLinkageResultsFilename(), getDistanceResultsFilename(), DEFAULT_NUMBER_OF_RECORDS_TO_BE_CHECKED,NUMBER_OF_RUNS).run();
    }
}
