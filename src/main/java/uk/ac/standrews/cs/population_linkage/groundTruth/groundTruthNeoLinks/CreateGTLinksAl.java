...
public class CreateGTLinksAl {
    ...
    private static final String DEATH_GROOM_IDENTITY = "MATCH (a:Death),(m:Marriage) WHERE a.DECEASED_IDENTITY = m.GROOM_IDENTITY CREATE (a)-[r:GROUND_TRUTH_DEATH_GROOM_IDENTITY]->(m)";
    ...
    private static final String BIRTH_BIRTH_HALF_SIBLING =
            "MATCH (a:Birth),(b:Birth) WHERE " +
                    ...
                    "CREATE (a)-[r:GROUND_TRUTH_BIRTH_HALF_SIBLING_LINKAGE]->(b)";
    ...
    private static final String DEATH_DEATH_HALF_SIBLING =
            "MATCH (a:Death),(b:Death) WHERE " +
                    ...
                    "AND NOT (a.MOTHER_IDENTITY = b.MOTHER_IDENTITY AND a.FATHER_IDENTITY = b.FATHER_IDENTITY) " +
                    "AND NOT ( a.MOTHER_IDENTITY = '' OR b.MOTHER_IDENTITY = '' OR a.FATHER_IDENTITY = '' OR b.FATHER_IDENTITY = '' " +
                    "CREATE (a)-[r:GROUND_TRUTH_DEATH_HALF_SIBLING_LINKAGE]->(b)";
    ...
    private void createGTLinks() {
        ...
        timeQuery( "Sibling marriages", BRIDE_GROOM_SIBLING, GROOM_BRIDE_SIBLING, GROOM_GROOM_SIBLING, BRIDE_BRIDE_SIBLING );
    ...
    public static void main(String[] args) {
        try (NeoDbCypherBridge bridge = new NeoDbCypherBridge()) {
            CreateGTLinksAl gt_link_creator = new CreateGTLinksAl(bridge);
