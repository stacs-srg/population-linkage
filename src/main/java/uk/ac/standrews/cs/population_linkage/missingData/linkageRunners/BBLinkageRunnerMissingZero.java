...
public class BBLinkageRunnerMissingZero extends BitBlasterLinkageRunner {

    @Override
    protected Metric<LXP> getCompositeMetric(final LinkageRecipe linkageRecipe) {
        return new MissingZero(getBaseMetric(), linkageRecipe.getLinkageFields(), Birth.STANDARDISED_ID);
    }
