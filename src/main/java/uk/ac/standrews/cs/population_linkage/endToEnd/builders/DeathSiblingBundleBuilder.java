...
public class DeathSiblingBundleBuilder implements MakePersistent {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try(
            DeathSiblingLinkageRecipe linkageRecipe = new DeathSiblingLinkageRecipe(sourceRepo, number_of_records, DeathSiblingBundleBuilder.class.getName()) ) {

            runBuilder(linkageRecipe);
        }
    }

    public static void runBuilder(DeathSiblingLinkageRecipe linkageRecipe) throws Exception {
