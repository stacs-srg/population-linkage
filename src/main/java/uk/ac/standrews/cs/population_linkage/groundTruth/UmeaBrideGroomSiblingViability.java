 ...
 **/
public class UmeaBrideGroomSiblingViability extends AsymmetricSingleSourceLinkageAnalysis {

    private UmeaBrideGroomSiblingViability(Path store_path, String repo_name, int number_of_records_to_be_checked,
    ...
    protected LinkStatus isTrueMatch(LXP record1, LXP record2) {
        ...
        if (m1_bride_father_id.isEmpty() || m2_groom_father_id.isEmpty() || m1_bride_mother_id.isEmpty()
                || m2_groom_mother_id.isEmpty()) {
            return LinkStatus.UNKNOWN;
        }

        return m1_bride_father_id.equals(m2_groom_father_id) && m1_bride_mother_id.equals(m2_groom_mother_id)
    ...
    public static void main(String[] args) throws Exception {
        ...
        new UmeaBrideGroomSiblingViability(store_path, repo_name, DEFAULT_NUMBER_OF_RECORDS_TO_BE_CHECKED,
                NUMBER_OF_RUNS).run();
    }
}
