...
public class BirthGroomSiblingLinkageRecipe extends LinkageRecipe {
    ...
    public BirthGroomSiblingLinkageRecipe(String source_repository_name, String number_of_records, String links_persistent_name) {
    ...
    public static boolean isViable(final LXP record1, final LXP record2) {
        ...
        String marriage_name = CommonLinkViabilityLogic.getGroomNameFromMarriageRecord(record2);
