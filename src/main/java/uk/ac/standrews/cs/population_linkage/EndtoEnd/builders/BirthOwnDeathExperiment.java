...
import uk.ac.standrews.cs.population_linkage.EndtoEnd.Recipies.BirthDeathSubsetIdentityLinkageRecipe;
...
public class BirthOwnDeathExperiment {
    ...
    public static void main(String[] args) throws BucketException {
        ...
        try ( NeoDbCypherBridge bridge = new NeoDbCypherBridge(); ) {
            LinkageRecipe linkageRecipe = new BirthDeathSubsetIdentityLinkageRecipe(sourceRepo, resultsRepo, bridge, BirthDeathIdentityLinkageRecipe.LINKAGE_TYPE + "-links", PREFILTER_FIELDS);
