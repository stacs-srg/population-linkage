...
public class AllPairsBridesParentsMarriageBirthUmeaIdentityLinkage extends AllPairs2SourcesLinkageAnalysis {
    ...
    public AllPairsBridesParentsMarriageBirthUmeaIdentityLinkage(Path store_path, String repo_name, String linkage_results_filename, final String distance_results_filename, long number_of_records_to_be_checked) throws IOException {
    ...
    protected LinkStatus isTrueLink(LXP record1, LXP record2) {
        ...
        final String m_parent_id1 = record1.getString(Marriage.BRIDE_FATHER_BIRTH_RECORD_IDENTITY);
        final String m_parent_id2 = record1.getString(Marriage.BRIDE_MOTHER_BIRTH_RECORD_IDENTITY);
