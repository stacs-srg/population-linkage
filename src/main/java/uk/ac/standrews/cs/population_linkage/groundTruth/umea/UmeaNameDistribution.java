...
public class UmeaNameDistribution {
    ...
    public UmeaNameDistribution(String output_path) {
    ...
    private void collectBirthNames(Iterable<Birth> births) {
        for (Birth b : births) {
            ...
            addToFirstNames(baby_firstname);
            addToSurnames(baby_surname);
            addToCombinedNames(baby_firstname, baby_surname);
            String father_firstname = b.getString(Birth.FATHER_FORENAME);
            String father_surname = b.getString(Birth.FATHER_SURNAME);
            addToFirstNames(father_firstname);
            addToSurnames(father_surname);
            addToCombinedNames(father_firstname, father_surname);
            String mother_firstname = b.getString(Birth.MOTHER_FORENAME);
            String mother_surname = b.getString(Birth.MOTHER_SURNAME);
            addToFirstNames(mother_firstname);
            addToSurnames(mother_surname);
            addToCombinedNames(mother_firstname, mother_surname);
        }
    }
    ...
    private void collectDeathNames(Iterable<Death> deaths) {
        for (Death d : deaths) {
            ...
            addToFirstNames(deceased_firstname);
            addToSurnames(deceased_surname);
            addToCombinedNames(deceased_firstname, deceased_surname);
    ...
    private void collectMarriageNames(Iterable<Marriage> marriages) {
        for (Marriage m : marriages) {
            ...
            addToFirstNames(groom_firstname);
            addToSurnames(groom_surname);
            addToCombinedNames(groom_firstname, groom_surname);
            ...
            addToFirstNames(groom_father_firstname);
            addToSurnames(groom_father_surname);
            addToCombinedNames(groom_father_firstname, groom_father_surname);
            ...
            addToFirstNames(groom_mother_firstname);
            addToSurnames(groom_mother_surname);
            addToCombinedNames(groom_mother_firstname, groom_mother_surname);

            String bride_firstname = m.getString(Marriage.BRIDE_FORENAME);
            String bride_surname = m.getString(Marriage.BRIDE_SURNAME);
            addToFirstNames(bride_firstname);
            addToSurnames(bride_surname);
            addToCombinedNames(bride_firstname, bride_surname);
            ...
            addToFirstNames(bride_father_firstname);
            addToSurnames(bride_father_firstname);
            addToCombinedNames(bride_father_firstname, bride_father_surname);
            ...
            addToFirstNames(bride_mother_firstname);
            addToSurnames(bride_mother_surname);
            addToCombinedNames(bride_mother_firstname, bride_mother_surname);
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        new UmeaNameDistribution("/Users/al/Desktop/").run();
    }
}
