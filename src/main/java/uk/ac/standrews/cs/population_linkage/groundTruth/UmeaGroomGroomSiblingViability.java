 ...
 **/
public class UmeaGroomGroomSiblingViability extends SymmetricSingleSourceLinkageAnalysis {

    private UmeaGroomGroomSiblingViability(Path store_path, String repo_name, int number_of_records_to_be_checked,
    ...
    protected LinkStatus isTrueMatch(LXP record1, LXP record2) {
        ...
        if (m1_groom_father_id.isEmpty() || m2_groom_father_id.isEmpty() || m1_groom_mother_id.isEmpty()
                || m2_groom_mother_id.isEmpty()) {
            return LinkStatus.UNKNOWN;
        }

        // Exclude matches for multiple marriages of the same groom.
        return !m1_groom_id.equals(m2_groom_id) && m1_groom_father_id.equals(m2_groom_father_id)
                && m1_groom_mother_id.equals(m2_groom_mother_id) ? LinkStatus.TRUE_MATCH : LinkStatus.NOT_TRUE_MATCH;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        new UmeaGroomGroomSiblingViability(store_path, repo_name, DEFAULT_NUMBER_OF_RECORDS_TO_BE_CHECKED,
                NUMBER_OF_RUNS).run();
    }
}
