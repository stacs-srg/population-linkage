...
public class Neo4JOGMCreateRelationships2 implements AutoCloseable
{
    ...
    public void make() {
        ...
        fred.addChild(al, "FATHER", al_br_evidence);

        sheila.addChild(al, "MOTHER", al_br_evidence);

        Evidence graham_br_evidence = new Evidence(graham_birth_record, 0.9, "some prov 3", 0.8);
        al.addChild( graham,"FATHER", graham_br_evidence );
        fiona.addChild( graham,"MOTHER", graham_br_evidence );

        Evidence alice_br_evidence = new Evidence(alice_birth_record, 0.9, "some prov 4", 0.8);
        al.addChild( alice,"FATHER", alice_br_evidence );
        fiona.addChild( alice,"MOTHER", alice_br_evidence );
    ...
    public static void main( String... args ) throws Exception
    {
        ...
        {
            db.make();
            System.out.println( "Created some vital event records - model 2" );
        }
    }
}
