...
public class BirthParentsMarriageIdentityLinkageRecipe extends LinkageRecipe {
    ...
    public static final String LINKAGE_TYPE = "birth-parents-marriage-identity-feligi-sunter";
    ...
    public BirthParentsMarriageIdentityLinkageRecipe(String source_repository_name, String number_of_records, List<Double> m_priors, List<Double> u_priors, double odds_prior, String links_persistent_name) {
