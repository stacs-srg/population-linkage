...
public class JobRunner_BirthDeathSiblingLinkageRunner extends LinkageRunner {
    ...
    public JobRunner_BirthDeathSiblingLinkageRunner(String populationName, String populationSize, String populationNumber,
    ...
    public static void main(String[] args) {
        ...
        new JobRunner_BirthDeathSiblingLinkageRunner(populationName, populationSize, populationNumber, corrupted,
