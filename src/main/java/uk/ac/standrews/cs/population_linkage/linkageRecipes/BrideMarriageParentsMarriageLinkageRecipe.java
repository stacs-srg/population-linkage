...
public class BrideMarriageParentsMarriageLinkageRecipe extends LinkageRecipe {
    ...
    public BrideMarriageParentsMarriageLinkageRecipe(String source_repository_name, String results_repository_name, String links_persistent_name) {
    ...
    public Map<String, Link> getGroundTruthLinks() {
        return getGroundTruthLinksOn(Marriage.BRIDE_FATHER_IDENTITY, Marriage.GROOM_IDENTITY);
    }

    @Override
    public int getNumberOfGroundTruthTrueLinks() {
        return getNumberOfGroundTruthTrueLinksOn(Marriage.BRIDE_FATHER_IDENTITY, Marriage.GROOM_IDENTITY);
    }
