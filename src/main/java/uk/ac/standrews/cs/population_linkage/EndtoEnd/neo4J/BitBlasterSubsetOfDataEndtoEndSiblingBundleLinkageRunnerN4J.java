...
public class BitBlasterSubsetOfDataEndtoEndSiblingBundleLinkageRunnerN4J extends BitBlasterLinkageRunner {
...
//    private HashMap<String, List<LXP>> gt;
    ...
    private void storeLinks(Link link) throws BucketException {
