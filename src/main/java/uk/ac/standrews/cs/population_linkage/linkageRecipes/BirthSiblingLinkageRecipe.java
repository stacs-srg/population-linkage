...
public class BirthSiblingLinkageRecipe extends LinkageRecipe {
    ...
    public BirthSiblingLinkageRecipe(String source_repository_name, String results_repository_name, String links_persistent_name, int prefilterRequiredFields) {
