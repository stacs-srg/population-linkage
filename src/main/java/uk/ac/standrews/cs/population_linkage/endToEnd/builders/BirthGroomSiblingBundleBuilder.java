...
public class BirthGroomSiblingBundleBuilder implements MakePersistent {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try(NeoDbCypherBridge bridge = new NeoDbCypherBridge() ) {
            ...
            BirthGroomSiblingLinkageRecipe linkageRecipe = new BirthGroomSiblingLinkageRecipe(sourceRepo, number_of_records, BirthGroomSiblingBundleBuilder.class.getName(), bridge);
