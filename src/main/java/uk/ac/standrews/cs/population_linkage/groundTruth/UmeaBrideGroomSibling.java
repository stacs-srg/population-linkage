...
public class UmeaBrideGroomSibling extends AsymmetricSingleSourceLinkageAnalysis {
    ...
    public UmeaBrideGroomSibling(Path store_path, String repo_name, String linkage_results_filename, final String distance_results_filename, int number_of_records_to_be_checked, int number_of_runs) throws IOException {
    ...
    protected LinkStatus isTrueLink(LXP record1, LXP record2) {
        ...
        return  m1_bride_father_id.equals(m2_groom_father_id) && m1_bride_mother_id.equals(m2_groom_mother_id)  ? LinkStatus.TRUE_LINK : LinkStatus.NOT_TRUE_LINK;
    ...
    public static void main(String[] args) throws Exception {
        ...
        new UmeaBrideGroomSibling(store_path, repo_name, getLinkageResultsFilename(), getDistanceResultsFilename(), DEFAULT_NUMBER_OF_RECORDS_TO_BE_CHECKED, NUMBER_OF_RUNS).run();
    }
}
