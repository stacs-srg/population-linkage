...
public class UmeaBrideGroomSibling extends AsymmetricSingleSourceLinkageAnalysis {
    ...
    private UmeaBrideGroomSibling(Path store_path, String repo_name, int number_of_records_to_be_checked, int number_of_runs) throws IOException {
    ...
    protected LinkStatus isTrueMatch(LXP record1, LXP record2) {
        ...
        return m1_bride_father_id.equals(m2_groom_father_id) && m1_bride_mother_id.equals(m2_groom_mother_id) ? LinkStatus.TRUE_MATCH : LinkStatus.NOT_TRUE_MATCH;
    }
