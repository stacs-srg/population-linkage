...
public class BrideBrideSiblingLinkageRecipe extends LinkageRecipe {
    ...
    public BrideBrideSiblingLinkageRecipe(String source_repository_name, String number_of_records, String links_persistent_name) {
    ...
    private static final String BRIDE_BRIDE_GT_SIBLING_LINKS_QUERY = "MATCH (a:Marriage)-[r:GT_SIBLING, { actors: \"Bride-Bride\" } ]-(b:Marriage) WHERE b.STANDARDISED_ID = $standard_id_from RETURN r";
