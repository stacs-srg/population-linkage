 ...
 */
package uk.ac.standrews.cs.population_linkage.EndtoEnd.neo4J;
 ...
 */
public class BirthSiblingBundleExperimentN4J {
    ...
    public static void main(String[] args) throws BucketException {
        ...
        new BitBlasterSubsetOfDataEndtoEndSiblingBundleLinkageRunnerN4J().run(linkageRecipe, new JensenShannon(2048), 0.67, true, 8, false, false, false, false);
