...
public abstract class GTLinksBase {
    ...
    protected static final String BIRTH_DEATH_IDENTITY = "MATCH (b:Birth),(d:Death) WHERE b.CHILD_IDENTITY = d.DECEASED_IDENTITY CREATE (b)-[r:GROUND_TRUTH_BIRTH_DEATH_IDENTITY]->(d)";
    // Do we need if bidirectional - think so?
    protected static final String DEATH_BIRTH_IDENTITY = "MATCH (b:Birth),(d:Death) WHERE b.CHILD_IDENTITY = d.DECEASED_IDENTITY CREATE (d)-[r:GROUND_TRUTH_DEATH_BIRTH_IDENTITY]->(b)";

    protected static final String BIRTH_GROOM_IDENTITY = "MATCH (b:Birth),(m:Marriage) WHERE b.CHILD_IDENTITY = m.GROOM_IDENTITY CREATE (b)-[r:GROUND_TRUTH_BIRTH_GROOM_IDENTITY]->(m)";
    protected static final String BIRTH_BRIDE_IDENTITY = "MATCH (b:Birth),(m:Marriage) WHERE b.CHILD_IDENTITY = m.BRIDE_IDENTITY CREATE (b)-[r:GROUND_TRUTH_BIRTH_BRIDE_IDENTITY]->(m)";

    protected static final String DEATH_GROOM_IDENTITY = "MATCH (d:Death),(m:Marriage) WHERE d.DECEASED_IDENTITY = m.GROOM_IDENTITY CREATE (d)-[r:GROUND_TRUTH_DEATH_GROOM_IDENTITY]->(m)";
    protected static final String DEATH_BRIDE_IDENTITY = "MATCH (d:Death),(m:Marriage) WHERE d.DECEASED_IDENTITY = m.BRIDE_IDENTITY CREATE (d)-[r:GROUND_TRUTH_DEATH_BRIDE_IDENTITY]->(m)";

    protected static final String BIRTH_DEATH_SIBLING = "MATCH (b:Birth),(d:Death) WHERE b.FATHER_IDENTITY = d.FATHER_IDENTITY AND b.MOTHER_IDENTITY = d.MOTHER_IDENTITY CREATE (b)-[r:GROUND_TRUTH_BIRTH_DEATH_SIBLING]->(d)";
    ...
    protected static final String BIRTH_BIRTH_SIBLING = "MATCH (a:Birth),(b:Birth) WHERE a.FATHER_IDENTITY = b.FATHER_IDENTITY AND a.MOTHER_IDENTITY = b.MOTHER_IDENTITY AND NOT a = b CREATE (a)-[r:GROUND_TRUTH_BIRTH_SIBLING]->(b)";
    protected static final String DEATH_DEATH_SIBLING = "MATCH (a:Death),(b:Death) WHERE a.FATHER_IDENTITY = b.FATHER_IDENTITY AND a.MOTHER_IDENTITY = b.MOTHER_IDENTITY AND NOT a = b CREATE (a)-[r:GROUND_TRUTH_DEATH_SIBLING]->(b)";
...
//    private static final String BIRTH_PARENTS_MARRIAGE_IDENTITY = "MATCH (a:Birth),(m:Marriage) WHERE a.FATHER_IDENTITY = m.GROOM_IDENTITY AND a.MOTHER_IDENTITY = m.BRIDE_IDENTITY CREATE (a)-[r:GROUND_TRUTH_BIRTH_PARENTS_MARRIAGE_IDENTITY]->(m)";
    protected static final String BIRTH_PARENTS_MARRIAGE = "MATCH (b:Birth),(m:Marriage) WHERE b.FATHER_IDENTITY = m.GROOM_IDENTITY AND b.MOTHER_IDENTITY = m.BRIDE_IDENTITY CREATE (b)-[r:GROUND_TRUTH_BIRTH_PARENTS_MARRIAGE]->(m)";

    // BIRTH_MOTHER_IDENTITY
    protected static final String MOTHER_OWNBIRTH_IDENTITY = "MATCH (a:Birth),(b:Birth) WHERE a.CHILD_IDENTITY = b.MOTHER_IDENTITY CREATE (a)-[r:GROUND_TRUTH_BIRTH_MOTHER_IDENTITY]->(b)";
    // BIRTH_FATHER_IDENTITY
    protected static final String FATHER_OWNBIRTH_IDENTITY = "MATCH (a:Birth),(b:Birth) WHERE a.CHILD_IDENTITY = b.FATHER_IDENTITY CREATE (a)-[r:GROUND_TRUTH_BIRTH_FATHER_IDENTITY]->(b)";

    // Fine though don't think we have recipes for these.
    protected static final String FATHER_GROOM_IDENTITY = "MATCH (b:Birth),(m:Marriage) WHERE b.FATHER_IDENTITY = m.GROOM_IDENTITY CREATE (b)-[r:GROUND_TRUTH_FATHER_GROOM_IDENTITY]->(m)";
    protected static final String MOTHER_BRIDE_IDENTITY = "MATCH (b:Birth),(m:Marriage) WHERE b.MOTHER_IDENTITY = m.BRIDE_IDENTITY CREATE (b)-[r:GROUND_TRUTH_MOTHER_BRIDE_IDENTITY]->(m)";

    protected static final String BRIDE_GROOM_SIBLING = "MATCH (a:Marriage),(b:Marriage) WHERE b.GROOM_MOTHER_IDENTITY = a.BRIDE_MOTHER_IDENTITY AND b.GROOM_FATHER_IDENTITY = a.BRIDE_FATHER_IDENTITY CREATE (a)-[r:GROUND_TRUTH_BRIDE_GROOM_SIBLING]->(b)";
    // Why do we need this one?
    protected static final String GROOM_BRIDE_SIBLING = "MATCH (a:Marriage),(b:Marriage) WHERE a.GROOM_MOTHER_IDENTITY = b.BRIDE_MOTHER_IDENTITY AND a.GROOM_FATHER_IDENTITY = b.BRIDE_FATHER_IDENTITY CREATE (a)-[r:GROUND_TRUTH_GROOM_BRIDE_SIBLING]->(b)";
    protected static final String GROOM_GROOM_SIBLING = "MATCH (a:Marriage),(b:Marriage) WHERE a.GROOM_MOTHER_IDENTITY = b.GROOM_MOTHER_IDENTITY AND (a.GROOM_FATHER_IDENTITY = b.GROOM_FATHER_IDENTITY)) AND NOT a = b CREATE (a)-[r:GROUND_TRUTH_GROOM_GROOM_SIBLING]->(b)";
    protected static final String BRIDE_BRIDE_SIBLING = "MATCH (a:Marriage),(b:Marriage) WHERE a.BRIDE_MOTHER_IDENTITY = b.BRIDE_MOTHER_IDENTITY AND (a.BRIDE_FATHER_IDENTITY = b.BRIDE_FATHER_IDENTITY)) AND NOT a = b  CREATE (a)-[r:GROUND_TRUTH_BRIDE_BRIDE_SIBLING]->(b)";
    ...
    protected static final String BIRTH_BIRTH_HALF_SIBLING =
    ...
    protected static final String DEATH_DEATH_HALF_SIBLING =
    ...
    protected static final String BIRTH_DEATH_HALF_SIBLING =
    ...
    public GTLinksBase(NeoDbCypherBridge bridge) {
        this.bridge = bridge;
    }
