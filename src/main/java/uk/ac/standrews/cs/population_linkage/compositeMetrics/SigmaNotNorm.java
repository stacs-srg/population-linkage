 ...
 */
public class SigmaNotNorm extends Metric<LXP> {

    final StringMetric base_distance;
    final List<Integer> field_list;
    final int id_field_index;

    public SigmaNotNorm(final StringMetric base_distance, final List<Integer> field_list, final int id_field_index) {
