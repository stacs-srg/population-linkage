...
src/main/scripts/experiments/umea_bit_blaster_sibling_bundling.sh 100
...
src/main/scripts/experiments/umea_bride_parents.sh 100
src/main/scripts/experiments/umea_death_birth.sh 100
...
src/main/scripts/experiments/umea_groom_parents.sh 100
