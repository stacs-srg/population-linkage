...
mvn exec:java -q -Dexec.cleanupDaemonThreads=false -Dexec.mainClass="uk.ac.standrews.cs.population_linkage.endToEnd.builders.GroomBrideSiblingBuilder" -e -Dexec.args="umea EVERYTHING"
