...
scp -i ~/.ssh/id_rsa_2 -q ${MAVEN_USER}@${MAVEN_HOST}:${MAVEN_REPO_PATH}/uk/ac/standrews/cs/${PROJECT}/1.0-SNAPSHOT/maven-metadata.xml .
...
scp -i ~/.ssh/id_rsa_2 -q ${MAVEN_USER}@${MAVEN_HOST}:${MAVEN_REPO_PATH}/uk/ac/standrews/cs/${PROJECT}/1.0-SNAPSHOT/${JAR_FILE} .
